...
const ALL_MOVES: CombatMove[] = [
  ...
  { id: "poke_fire_fire-punch", name: "Liquidation Punch", type: "FIRE" as CombatType, power: 75, accuracy: 100, pp: 15, category: "physical" as const, description: "A fiery punch that liquidates on contact. May burn.", effects: [{ type: "status", chance: 10, status: "burned" }] },
  { id: "poke_fire_ember", name: "FUD Spark", type: "FIRE" as CombatType, power: 40, accuracy: 100, pp: 25, category: "special" as const, description: "Throws a small spark of fear and doubt. May burn the foe.", effects: [{ type: "status", chance: 10, status: "burned" }] },
  ...
  { id: "poke_fire_will-o-wisp", name: "Spite Flame", type: "FIRE" as CombatType, power: 0, accuracy: 85, pp: 15, category: "status" as const, description: "Lights the opponent on fire out of pure spite.", effects: [{ type: "status", chance: 100, status: "burned" }] },
  ...
  // WATER (8 moves)
  { id: "poke_water_wave-crash", name: "Whale Splash", type: "WATER" as CombatType, power: 110, accuracy: 100, pp: 10, category: "physical" as const, description: "A massive whale splash that drenches the foe. Recoil damage." },
  ...
  { id: "poke_ground_sandsear-storm", name: "Sandstorm Rage", type: "EARTH" as CombatType, power: 100, accuracy: 80, pp: 10, category: "special" as const, description: "A desert sandstorm of rage. May burn." },
  { id: "poke_ground_headlong-rush", name: "Face Plant", type: "EARTH" as CombatType, power: 110, accuracy: 100, pp: 5, category: "physical" as const, description: "Slams the ground face-first. Lowers own DEF." },
  ...
  { id: "poke_ground_scorching-sands", name: "Hot Sand", type: "EARTH" as CombatType, power: 70, accuracy: 100, pp: 10, category: "special" as const, description: "The sand is literally on fire. May burn.", effects: [{ type: "status", chance: 30, status: "burned" }] },
  ...
  { id: "poke_flying_dragon-ascent", name: "Sent To Heaven", type: "AIR" as CombatType, power: 110, accuracy: 100, pp: 5, category: "physical" as const, description: "Sends the foe heavenward. Lowers their DEF.", effects: [{ type: "stat_drop", chance: 100, stat: "defense", stages: 1, target: "opponent" }] },
  // PSYCHE (11 moves)
  ...
  { id: "poke_dragon_dragon-dance", name: "Dragon Dance", type: "DRAGON" as CombatType, power: 0, accuracy: 100, pp: 20, category: "status" as const, description: "The legendary dragon dance. Raises ATK and Speed.", effects: [{ type: "stat_boost", stat: "attack", stages: 1, target: "self" }] },
  ...
  { id: "poke_fairy_fleur-cannon", name: "Sparkle Bomb", type: "MYSTIC" as CombatType, power: 110, accuracy: 90, pp: 5, category: "special" as const, description: "A sparkling bomb that drops foe Sp.Atk sharply.", effects: [{ type: "stat_drop", chance: 100, stat: "sp_atk", stages: 2, target: "opponent" }] },
