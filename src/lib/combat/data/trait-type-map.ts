...
export const TRAIT_COMBAT_MAP: Record<string, TraitCombatEntry> = {
  ...
  'Eyes_Ninja-Turtle-Mask':                 e('Eyes_Ninja-Turtle-Mask',                 'Eyes', 'Ninja Turtle Mask',           true,  'WATER',    5, 'MARTIAL',  2, 'defense', 3),
  ...
  'Head_Spikes':                            e('Head_Spikes',                            'Head', 'Anarchy Spikes',              true,  'VENOM',    5, 'SHADOW',   2, 'attack',  3),
  'Head_Beanie':                            e('Head_Beanie',                            'Head', 'Beanie',                      true,  'ICE',      5, 'NEUTRAL',  2, 'sp_def',  3),
  ...
  'Head_Centurion':                         e('Head_Centurion',                         'Head', 'Centurion',                   true,  'STONE',    5, 'MARTIAL',  2, 'defense', 3),
  ...
  'Head_Ronin-helmet':                      e('Head_Ronin-helmet',                      'Head', 'Ronin Helmet',                true,  'METAL',    5, 'MARTIAL',  2, 'defense', 3),
