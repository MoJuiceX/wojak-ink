...
function OfferFileModal({ nft, offerFile, onClose, onCopy }) {
  ...
  return (
    <div
      ref={backdropRef}
      data-modal-backdrop="offer-file-modal"
      style={{
        position: 'fixed',
        top: 0,
        left: 0,
        ...
        alignItems: 'center',
        justifyContent: 'center',
        zIndex: 9999, // Below taskbar (10000) but above windows
      }}
      onClick={onClose}
    >
      <div
        className="marketplace-offer-modal-content"
        style={{
          background: '#c0c0c0',
  ...
  return (
    ...
    >
      <div style={{ padding: '8px' }}>
        ...
        {isLoadingInitial ? (
          <div
            className="marketplace-nft-grid-scrollable"
            style={{
              display: 'grid',
